...
class ASTModel(nn.Module):
    ...
    def __init__(self, label_dim=527, fstride=10, tstride=10, input_fdim=128, input_tdim=1024, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=True):
        ...
        # now load a model that is pretrained on both ImageNet and AudioSet
            ...
            if os.path.exists('../ast/pretrained_models/ast_audioset.pth') == False:
                # this model performs 0.4593 mAP on the audioset eval set
                audioset_mdl_url = 'https://www.dropbox.com/s/cv4knew8mvbrnvq/audioset_0.4593.pth?dl=1'
                wget.download(audioset_mdl_url, out='../ast/pretrained_models/ast_audioset.pth')
            sd = torch.load('../ast/pretrained_models/ast_audioset.pth', map_location=device)
